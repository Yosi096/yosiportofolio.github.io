...
<head>
    ...
    <title>Portofolio - Yosi Mardianti</title>
...
<body>
    ...
    <nav class="navbar">
        <div class="max-width">
            <div class="logo"><a href="#">MyPorto<span>folio.</span></a></div>
            <ul class="menu">
      ...
      <div class="max-width">
          <div class="row">
            <div class="home-content">
                ...
                <div class="text-2">Yosi Mardianti</div>
                <div class="text-3">dan saya <span class="typing"></span></div>
            </div>
          </div>
      </div>
    </section>
    ...
    <footer>
        <span>Created By yosi</a> | <span class="far fa-copyright"></span> 2021 All rights reserved.</span>
    </footer>
